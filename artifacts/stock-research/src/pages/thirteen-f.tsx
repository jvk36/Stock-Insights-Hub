...
const FUND_LINKS: Record<string, FundLink[]> = {
  ...
  "1556785": [ // Vulcan Value Partners — C.T. Fitzpatrick
    { title: "Vulcan Value Partners — Official Website", url: "https://www.vulcanvaluepartners.com/", type: "website", description: "Birmingham, Alabama-based value investment firm founded by C.T. Fitzpatrick in 2007. Vulcan runs concentrated, long-only portfolios of high-quality businesses with durable competitive advantages, purchased with a significant margin of safety." },
    { title: "Vulcan Value Partners — Investment Philosophy", url: "https://www.vulcanvaluepartners.com/philosophy/", type: "article", description: "Fitzpatrick's framework for identifying businesses with stable, predictable free cash flow and durable competitive advantages — combined with a strict valuation discipline requiring a meaningful discount to intrinsic value before initiating a position." },
    { title: "SEC EDGAR — Vulcan Value Partners 13F Filings", url: "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=1556785&type=13F", type: "report", description: "Direct link to all 13F-HR filings on SEC EDGAR." },
  ],
  "1089755": [ // SouthernSun Asset Management — Michael Cook
    { title: "SouthernSun Asset Management — Official Website", url: "https://www.southernsunam.com/", type: "website", description: "Memphis-based concentrated small- and mid-cap value manager founded by Michael Cook in 1989. SouthernSun runs highly focused portfolios of high-quality, owner-operated businesses purchased at significant discounts to intrinsic value, with typical holding periods measured in years." },
    { title: "SouthernSun — Investment Philosophy", url: "https://www.southernsunam.com/investment-approach/", type: "article", description: "Overview of SouthernSun's bottom-up, fundamental research process: deep qualitative analysis of management quality, competitive dynamics, and balance sheet strength, with a strong preference for businesses with durable competitive advantages." },
    { title: "SEC EDGAR — SouthernSun Asset Management 13F Filings", url: "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=1089755&type=13F", type: "report", description: "Direct link to all 13F-HR filings on SEC EDGAR." },
  ],
