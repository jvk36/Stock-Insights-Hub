...
| Vulcan Value Partners | 1556785 | vulcan-value-partners | C.T. Fitzpatrick | ~50–60 | Birmingham, AL concentrated quality-value; 41 quarters (Q1 2016–Q1 2026); 1,886 total holdings; 14 overrides — CWK (Cushman & Wakefield, G-CUSIP), AHL (Aspen Insurance), NAVG (Navigators Group), SCSS (Select Comfort→Sleep Number), TUP (Tupperware), DNB (Dun & Bradstreet), NCI (Navigant Consulting), KNL (Knoll), CG (Carlyle), CEB (CEB Inc), LSTR (Landstar, Yahoo missed), B (Barnes Group), ESMT (EngageSmart), PLKI (Popeyes); 0 intentional nulls |
| SouthernSun Asset Management | 1089755 | southernsun | Michael Cook | ~26–39 | Memphis-based concentrated SMID-cap value; 41 quarters (Q1 2016–Q1 2026); 1,318 total holdings; 6 overrides — NFX (Newfield Exploration), AEGN (Aegion), CCMP (CMC Materials), TMX (Terminix), WAC (Walter Investment Mgmt), MDY (SPDR MidCap 400 ETF); 0 intentional nulls |
| Semper Augustus Investment Group | 1115373 | semper-augustus | Christopher Bloomstran | ~25–42 | Colorado-based concentrated value; 41 quarters (Q1 2016–Q1 2026); 7 overrides — MCY (Mercury General, flagship holding), AVX, HFC (HollyFrontier), SIVR, RCII, VICL (×2 CUSIP variants); 1 intentional null — 74347B714 (ProShares ETF trust, specific fund unidentifiable); 1,262 total holdings |
| Aquamarine Capital Management | 1404599 | aquamarine-capital | Guy Spier | ~4–13 | Zurich-based Buffett-style partnership; files in true thousands (standard 13F format); 42 quarters (Q1 2016–Q2 2026); CIK 1404599 covers Q1 2016–Q2 2022, linkedCik 1953324 covers Q3 2022–Q2 2026; 0 nulls after 2 overrides — BAC, ENLC; 489 total holdings |
| Polen Capital Management | 1034524 | polen-capital | David Polen | ~34–235 | Boca Raton multi-strategy growth manager (Focus Growth flagship + small/mid-cap strategies); 41 quarters (Q1 2016–Q1 2026); 28 overrides (ALTR, MDSO, CWAN, ENV, MMYT, AZPN, IBP, MPWR, RELX, SMR, CAAP, MYTE, CMD, PLPC, USPH, ELLI, NTRI, MLI, GTES, PBH, CHEF, MLR, THR, VECO, CPS, MTSI, WAGE, SVV); 8 intentional nulls (3 Vanguard mutual fund share CUSIPs, 2 ETF trusts, 1 Deluxe debt note, 1 Cantor SPAC, 1 NV5 Global unconfirmed ticker); 3,428 total holdings |
